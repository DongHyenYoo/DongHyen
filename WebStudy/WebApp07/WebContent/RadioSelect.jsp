...
<div>
<h2>RadioSelect.jsp -> Radio.Select_ok.jsp</h2>
...
성별
<label>
	<input type="radio" name="gender" class="txt" value="M">남자
</label>
<label>
	<input type="radio" name="gender" class="txt" value="W">여자
</label>
<br><br>
