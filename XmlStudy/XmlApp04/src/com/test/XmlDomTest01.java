...
public class XmlDomTest01
{
	...
	// 1. XML 파일을 메모리에 로드 → XML DOM 형성 객체를 기반으로 모든걸 생성하므로 
			// 2. 루트 엘리먼트 접근
	...
	//온전히 자바와 관련된 Resource만 사용할때는 try-catch를 안써도됨
	//단 이외의 것들을 참조한다면 써야한다.
	...
	private static String getText(Element parent, String tagName)
	{
		...
		//특정 엘리먼트의 자식노드(Text Node)의 값(nodeValue)를 얻어올 수 있도록 처리 
