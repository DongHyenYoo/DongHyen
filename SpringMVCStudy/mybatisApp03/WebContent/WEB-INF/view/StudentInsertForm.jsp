          	...
          	<tr>
          		<td>
          			<div class="input-group" role="group">
          				...
          				<input type="text" id="name" name="name" class="form-control" placeholder="name" maxlength="30" required="required">
          	...
          	<tr>
          		<td>
          			<div class="input-group" role="group">
          				...
          				<input type="text" id="tel" name="tel" class="form-control" placeholder="tel" maxlength="30" required="required">
