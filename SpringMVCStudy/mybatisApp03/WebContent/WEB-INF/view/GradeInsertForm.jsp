          	...
          	<tr>
          		<td>
          			<div class="input-group" role="group">
          				...
          				<input type="text" id="sid" name="sid" class="form-control" placeholder="sid" maxlength="30" required="required">
          	...
          	<tr>
          		<td>
          			<div class="input-group" role="group">
          				...
          				<input type="text" id="sub1" name="sub1" class="form-control" placeholder="0" maxlength="30" required="required">
          			</div>
          		</td>
          	</tr>
          	...
          	<tr>
          		<td>
          			<div class="input-group" role="group">
          				...
          				<input type="text" id="sub2" name="sub2" class="form-control" placeholder="0" maxlength="30" required="required">
          			</div>
          		</td>
          	</tr>
          		<tr style="height: 10px;">
          	...
          	<tr>
          		<td>
          			<div class="input-group" role="group">
          				...
          				<input type="text" id="sub3" name="sub3" class="form-control" placeholder="0" maxlength="30" required="required">
          			</div>
          		</td>
          	</tr>
