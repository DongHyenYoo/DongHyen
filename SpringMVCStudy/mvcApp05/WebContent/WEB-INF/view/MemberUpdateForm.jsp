			...
			<form action="memberupdate.action" method="post" id="memberForm">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" id="tel1" name="tel1" placeholder="ex)010" style="width: 20%" value="${fn:substring(member.tel,0,3) }">
						- <input type="text" id="tel2" name="tel2"  style="width: 20%" value="${fn:substring(member.tel,4,8) }">
						- <input type="text" id="tel3" name="tel3"  style="width: 20%" value="${fn:substring(member.tel,9,13) }">
						<button type="button" id="checkTel">중복확인</button>
					</div>

					<div class="input-group">
						<div class="input-group-addon">이메일</div>
						<input type="text" id="email" name="email" value="${fn:substringBefore(member.email, '@')}"> @ <select
							id="eAddress" name="eAddress">
							<option value="gmail.com" ${fn:substringAfter(member.email, '@') == "test.com" ? "selected=\"selected\"" : ""}>gmail.com</option>
							<option value="test.com" ${fn:substringAfter(member.email, '@') == "test.com" ? "selected=\"selected\"" : ""}>test.com</option>
							<option value="sist.com" ${fn:substringAfter(member.email, '@') == "test.com" ? "selected=\"selected\"" : ""}>sist.com</option>
						</select>
					...
					<div class="input-group">
						<input type="button" id="insertBtn" class="insertBtn" value="수정완료" />
