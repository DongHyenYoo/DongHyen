...
AS
SELECT E.EMP_ID "EMP_ID", E.EMP_NAME "EMP_NAME", E.SSN "SSN", E.IBSADATE "IBSADATE"
     , C.CITY_LOC "CITY_LOC" , E.TEL "TEL" , B.BUSEO_NAME "BUSEO_NAME" , J.JIKWI_NAME "JIKWI_NAME"
     , J.MIN_BASICPAY "MIN_BASICPAY" , E.BASICPAY "BASICPAY" , E.SUDANG "SUDANG"
     , (E.BASICPAY + E.SUDANG) AS PAY
FROM TBL_EMP E, TBL_CITY C, TBL_BUSEO B, TBL_JIKWI J
WHERE E.CITY_ID = C.CITY_ID
  AND E.BUSEO_ID = B.BUSEO_ID
...
--1.직원 정보 입력 sql
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES(EMPSEQ.NEXTVAL, 유동현, '940601-1024419', TO_DATE('1994-06-06','YYYY-MM-DD'), 4 , '010-3578-3912', 6, 9, 1250000, 3333)
;

--2.전체 직원 정보 출력
SELECT E.EMP_ID AS EMP_ID, E.EMP_NAME AS EMP_NAME, E.SSN AS SSN, E.IBSADATE AS IBSADATE, C.CITY_LOC AS CITY_LOC , E.TEL AS TEL , B.BUSEO_NAME AS BUSEO_NAME , J.JIKWI_NAME AS JIKWI_NAME, J.MIN_BASICPAY AS MIN_BASICPAY , E.BASICPAY AS BASICPAY , E.SUDANG AS SUDANG, (E.BASICPAY + E.SUDANG) AS PAY FROM TBL_EMP E, TBL_CITY C, TBL_BUSEO B, TBL_JIKWI J WHERE E.CITY_ID = C.CITY_ID AND E.BUSEO_ID = B.BUSEO_ID AND E.JIKWI_ID = J.JIKWI_ID ORDER BY EMP_ID
;
...
SELECT E.EMP_ID AS EMP_ID, E.EMP_NAME AS EMP_NAME, E.SSN AS SSN, E.IBSADATE AS IBSADATE, E.CITY_ID AS CITY_ID , E.TEL AS TEL , B.BUSEO_ID AS BUSEO_NAME , J.JIKWI_NAME AS JIKWI_NAME, J.MIN_BASICPAY AS MIN_BASICPAY , E.BASICPAY AS BASICPAY , E.SUDANG AS SUDANG, (E.BASICPAY + E.SUDANG) AS PAY FROM TBL_EMP E, TBL_CITY C, TBL_BUSEO B, TBL_JIKWI J WHERE E.CITY_ID = C.CITY_ID AND E.BUSEO_ID = B.BUSEO_ID AND E.JIKWI_ID = J.JIKWI_ID ORDER BY EMP_ID
;
...
--직원 정보 수정
UPDATE TBL_EMP SET EMP_NAME = '유동현', SSN = '940601-1024419', IBSADATE = TO_DATE('1994-06-01', 'YYYY-MM-DD'), CITY_ID = 5, TEL = '010-3578-3912', BUSEO_ID = 2, JIKWI_ID = 5, BASICPAY = 1000000, SUDANG = 200000 WHERE EMP_ID = 1001
;
...
--전체 직위 최소 급여
SELECT JIKWI_NAME, MIN_BASICPAY FROM TBL_JIKWI
;
...
SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME LIKE '과장'
;

--부서 이름에 따른 번호 가져오기
SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME LIKE '개발부'
;

--지역 이름에 따른 번호 가져오기
SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC LIKE '서울'
;
...
INSERT INTO TBL_EMP(EMP_ID, EMP_NAME, SSN, IBSADATE, CITY_ID, TEL, BUSEO_ID, JIKWI_ID, BASICPAY, SUDANG) VALUES(EMPSEQ.NEXTVAL, '유동현', '940601-1024419', TO_DATE('1994-06-06','YYYY-MM-DD'), (SELECT CITY_ID FROM TBL_CITY WHERE CITY_LOC LIKE '서울'), '010-3578-3912', (SELECT BUSEO_ID FROM TBL_BUSEO WHERE BUSEO_NAME LIKE '개발부'), (SELECT JIKWI_ID FROM TBL_JIKWI WHERE JIKWI_NAME LIKE '과장'), 1250000, 3333)
;
